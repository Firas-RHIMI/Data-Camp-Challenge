...
def get_flow_data(test=False): #Processes raw data and return flow data for predictions
    ...
    try:
        ...
        data.to_csv(os.path.join(path, 'flow_data.csv'))
